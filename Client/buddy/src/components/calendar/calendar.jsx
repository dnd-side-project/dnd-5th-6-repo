...
const Calendar = () => {
    ...
    return (
        <div>
          ...
          <div onClick={() => { setMoment(getMoment.clone().add(1, 'month')) }}>
          <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M7.5 4.5L13 10L7.5 15.5" stroke="#C5C5C5" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
          </svg>
          </div>
            </div>
            <div>
